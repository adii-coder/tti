...
# Toggle Between Image Generation & Enhancement
if "mode" not in st.session_state:
    st.session_state.mode = "image_generation"

def toggle_mode():
    st.session_state.mode = "image_enhancement" if st.session_state.mode == "image_generation" else "image_generation"

mode_button_label = "Image Enhancement" if st.session_state.mode == "image_generation" else "Image Generation"
st.sidebar.button(mode_button_label, on_click=toggle_mode)

# ---- 🌟 Image Generation Section 🌟 ----
if st.session_state.mode == "image_generation":
    st.title("🌟 Rachna - AI Image Creator 🌟")
    st.markdown("**Create stunning AI-generated images with ease!** 🎨✨")
    ...
    resolution = st.sidebar.radio("🎨 Select Resolution", list(resolution_map.keys()), index=3)
    num_variations = st.sidebar.slider("🔄 Number of Variations", 1, 5, 1)
...
# ---- 🌟 Image Enhancement Section 🌟 ----
if st.session_state.mode == "image_enhancement":
